              ...
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color:   widget.heatValue<=26 ? Colors.blue : Colors.black54,
                    ),
                  ),
                  Text(
                    "Mid",
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color: widget.heatValue >= 30 ? Colors.blue : Colors.black54,
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color: widget.heatValue >= 34  ? Colors.blue : Colors.black54,
                    ),
                  ),
                ],
              ),
